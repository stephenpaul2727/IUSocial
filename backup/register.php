		...
		<div class="login_box">
			...
			<div id="second">
				...
				<form action="register.php" method="POST">
					...
					<input type="text" name="reg_title" placeholder="Title (eg. MS in CS, Assistant Professor, IU Alumi etc.)" required>
					<br>
					<?php if(in_array("Your title must be between 2 and 20 characters<br>", $error_array)) echo "Your title must be between 2 and 50 characters<br>"; ?>
