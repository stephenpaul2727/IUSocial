...
***********************************************************/
	if (!isset($_POST['x']) && !isset($_FILES['image']['name']) ){
		//Delete users temp image
			$temppath = 'assets/images/group_pics/'.$profile_id.'_temp.jpeg';
...
***********************************************************/	
	...
	//Set Upload directory    
		// $uploaddir = $_SERVER['DOCUMENT_ROOT'].'/Demo/assets/images/group_pics';
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/IUSoc2/assets/images/group_pics';
	//Set File name	
...
if (isset($_POST['x'])){
	...
	if($type == 'jpg' || $type == 'jpeg' || $type == 'JPG' || $type == 'JPEG'){	
		...
		$result_path ="assets/images/group_pics/".$finalname."n.jpeg";
    ...
    if($imgSrc){ //if an image has been uploaded display cropping area?>
	    ...
	    <div id="CroppingContainer" style="width:800px; max-height:600px; background-color:#FFF; margin-left: -200px; position:relative; overflow:hidden; border:2px #666 solid; z-index:2001; padding-bottom:0px;">  
	        ...
	        <div id="CropImageForm" style="width:100px; height:30px; float:left; margin:10px 0px 0px 40px;" >  
	            <form action="<?php echo "upload_group_pic.php?group_name=".$profileId; ?>" method="post" onsubmit="return checkCoords();">
	        ...
	        <div id="CropImageForm2" style="width:100px; height:30px; float:left; margin:10px 0px 0px 40px;" >  
	            <form action=action="<?php echo "upload_group_pic.php?group_name=".$profileId; ?>"  method="post" onsubmit="return cancelCrop();">
