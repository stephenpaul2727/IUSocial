...
<head>
  ...
  <style>
    ...
    #wrapper {
      width: 100%;
      height: 100%;
      background-image: url("http://localhost:220/IUSocial/assets/images/backgrounds/newwally.jpg");
...
<body>
  <div id="wrapper">
    <Button class="low_button" onclick="window.location.href='welcome3.php'">
    </Button>
  </div>
</body>
</html>