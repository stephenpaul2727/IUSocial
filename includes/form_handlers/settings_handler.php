...
if(isset($_POST['update_details'])) {
	...
	if($matched_user == "" || $matched_user == $userLoggedIn) {
		$message = "<br><br>Details updated!<br><br>";

		$query = mysqli_query($con, "UPDATE users SET first_name='$first_name', last_name='$last_name', email='$email', title='$title', about='$about', project='$project' WHERE username='$userLoggedIn'");
	}
	else 
